#!/bin/bash
#to be sourced from run_level2.sh
echo '' > $FILE
cat >> $FILE <<EOF
...
set feat_files(2) ${FEATDIR2}

# 4D AVW data or FEAT directory (3)
set feat_files(3) ${FEATDIR3}

# 4D AVW data or FEAT directory (4)
set feat_files(4) ${FEATDIR4}

# Add confound EVs text file
set fmri(confoundevs) 0

# EV 1 title
set fmri(evtitle1) "SubMean"
